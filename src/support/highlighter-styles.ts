 ...
 */
export const darkModeCss = (wordWrap: boolean): { [key: string]: React.CSSProperties } => {
  return {
    "pre[class*=\"language-\"]": {
      "color": "#d4d4d4",
    ...
    "code[class*=\"language-\"]": {
      ...
      "textAlign": "left",
      "whiteSpace": "pre",
      "wordWrap": `${wordWrap ? "break-word" : "inherit"}`,
      "wordSpacing": "normal",
      "wordBreak": "normal",
      "lineHeight": "1.5",
      "MozTabSize": "4",
...
export const lightModeCss = (wordWrap: boolean): { [key: string]: React.CSSProperties } => {
  return {
    "pre[class*=\"language-\"]": {
      "color": "black",
      "background": `${background}`, //jpi
      ...
      "wordSpacing": "normal",
      "wordBreak": "normal",
      //"wordWrap": "normal", dark doesn't use this on pre, but on code so will try there.
